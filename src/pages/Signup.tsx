      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-12">
          ...
          <p className="text-muted-foreground mt-4 text-sm max-w-sm leading-relaxed">
            Create your free account and start connecting with your team in seconds.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" placeholder="you@example.com" className="w-full bg-card border border-border rounded-xl pl-10 pr-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-foreground/30 transition-all" />
              </div>
            </div>
            <div>
            ...
            <label className="flex items-start gap-2 text-sm text-muted-foreground cursor-pointer">
              <input type="checkbox" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} className="w-3.5 h-3.5 rounded border-border bg-card mt-0.5" />
              <span>
                I agree to the{" "}
                <Link to="/terms" className="text-foreground hover:underline">Terms of Service</Link>
                {" "}and{" "}
                <Link to="/terms" className="text-foreground hover:underline">Privacy Policy</Link>
              </span>
            </label>
